...
def driver_control():
    ...
    while True:
        ...
        if left_speed >= 0:
            left_motors.spin(vex.DirectionType.FWD, )
        else:
            left_motors.spin(vex.DirectionType.REV)

        if right_speed >=0:
            right_motors.spin(vex.DirectionType.FWD)
        else:
            right_motors.spin(vex.DirectionType.REV)
